...
Moving average order (found from ACF): q - 1,2,3,4 <br>
...
```
Moving average order (found from ACF): q - 1,2,3,4,5 <br>
Autoregressive term (found from pACF): p - 1
...
```
Moving average order (found from ACF): q - 1,2,3 <br>
Autoregressive term (found from pACF): p - 1
...
**Production**
Must be differenced twice. A first difference results in a p-value of 0.99 by the ADF test: indicating that we can't reject the null hypothesis of no stationarity. Stationarity is only achieved with a second difference.
```{r}
...
```
Moving average order (found from ACF): q - 1 <br>
Autoregressive term (found from pACF): p - 1
...
Differencing: d = 0,1; D = 0,1 <br>
Moving average order: q = 0,1; Q = 0,1,2,3 <br>
Autoregressive terms: p = 0,1, P = 0,1 <br>
...
Differencing: d = 0,1; D = 0,1 <br>
Moving average order: q = 0,1,2,3,4; Q = 0,1,2,3 <br>
Autoregressive terms: p = 0,1, P = 0,1,2 <br>
...
Differencing: d = 0,1; D = 0,1 <br>
Moving average order (ACF): q = 0,1,2; Q = 0,1,2 <br>
Autoregressive terms (PACF): p = 0,1,2,3; P = 0,1,2,3 <br>
...
Differencing: d = 0,1; D = 0,1 <br>
Moving average order: q = 0,1; Q = 0,1 <br>
Autoregressive terms: p = 0,1,2,3,4; P = 0,1,2 <br>
...
**Coal**
ARIMA(1,1,1)(0,1,2) for both auto.arima() and manual fitting.
...
**Hydrocarbon**
ARIMA(2,0,1)(0,1,2) for auto.arima() and  ARIMA(1,1,2)(0,1,1) from manual fitting.
...
**Natural gas**
ARIMA(2,1,1)(1,1,1) for auto.arima() and ARIMA(1,1,1)(0,1,2) from manual fitting.
...
**Petroleum**
ARIMA(0,1,1)(0,0,2) for auto.arima() and ARIMA(0,1,1)(1,1,1) from manual fitting.
